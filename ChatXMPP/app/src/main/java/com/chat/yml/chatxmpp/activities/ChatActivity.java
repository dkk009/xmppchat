...
import com.chat.yml.chatxmpp.fragments.HomeFragment;
...
public class ChatActivity extends AppCompatActivity implements IntrFragmentCommunicator{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new HomeFragment(), HomeFragment.class.getSimpleName(), false);
